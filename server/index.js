...
// One-time LAUNCH announcement blast to the whole waitlist (2026-07-18,
// day after release). Guarded by ADMIN_TOKEN; throttled for Resend limits.
// Remove after use, like the confirmation backfill before it.
const APP_STORE_URL = 'https://apps.apple.com/app/id6786001252';
function sendLaunchEmail(email) {
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:16px;overflow:hidden;">
        ...
        <tr><td style="padding:36px 32px 8px;">
          <h1 style="margin:0 0 16px;font-size:26px;line-height:1.25;color:#101733;">We&rsquo;re live. &#128640;</h1>
          <p style="margin:0 0 16px;font-size:16px;line-height:1.6;color:#3c4563;">
            <strong>Trovault is officially on the App Store</strong> &mdash; you can
            download it right now.
          </p>
          <p style="margin:0 0 16px;font-size:16px;line-height:1.6;color:#3c4563;">
            You signed up before we launched, which makes you a founding user in my
            book. Your first 5 scans every month are free &mdash; point your iPhone at
            the most mysterious thing you own and see what it&rsquo;s actually worth.
          </p>
          <p style="margin:0 0 28px;font-size:16px;line-height:1.6;color:#3c4563;">
            Thank you for being here from day zero.<br>&mdash; Joshua
          </p>
        </td></tr>
        <tr><td align="center" style="padding:0 32px 36px;">
          <a href="${APP_STORE_URL}" style="display:inline-block;background:#2f6bff;color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;padding:14px 36px;border-radius:10px;">Download Trovault</a>
        </td></tr>
        <tr><td style="padding:24px 32px;background:#f7f9fd;border-top:1px solid #e8edf7;">
          <p style="margin:0;font-size:12px;line-height:1.6;color:#8a94b3;text-align:center;">
            ...
            This is the launch-day email we promised &mdash; the last one of its kind.<br>
...
Trovault is officially on the App Store — you can download it right now:
${APP_STORE_URL}

You signed up before we launched, which makes you a founding user in my book. Your first 5 scans every month are free — point your iPhone at the most mysterious thing you own and see what it's actually worth.

Thank you for being here from day zero.
— Joshua

You're receiving this because you joined the launch list at trovault.io. This is the launch-day email we promised.`;
  return fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      to: email,
      subject: 'Trovault is live on the App Store',
      html,
      text,
    }),
  }).catch(() => {});
...
app.post('/api/admin/launch-blast', async (req, res) => {
